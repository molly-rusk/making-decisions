...
/*
  Using an if statement and a comparison operator, create code
   that will check if Amy or Brittani is older, and then console.log '{name} is older'.
...
/*
  ...
  if Amy and Brittani were born in the same year. If they were, console.log 
  'Amy & Brittani were born in the same year'. If they were not, console.log 
...
if(temperature >=60 && temperature <= 80 && rain == true){
  console.log("You should wera a rain-jacket");
}
if(temperature <= 60){
  console.log("You should wer a jacket and carry an umbrella");
}
...
/*
  Create a while-loop that logs "Your score is not high enough" while the score variable  is below passingScore. 
